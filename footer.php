        ...
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    <img src="https://hoveloria.com/wp-content/uploads/2026/01/black-logo-png-latest.png" alt="<?php bloginfo('name'); ?>" class="footer-logo-img branded-logo" />
                </a>
...
<!-- Floating Cart Icon (Outside container to avoid clipping) -->
<a href="<?php echo esc_url(home_url('/shop/')); ?>" class="floating-cart-icon">
